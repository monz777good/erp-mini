...
export default function LoginPage() {
  ...
  useEffect(() => {
    // 자동로그인은 UI 체크만; 실제 자동 로그인 로직은 기존 API가 있으면 그대로 쓰면 됨
  }, []);
  ...
  return (
    <div className="erp-container" style={{ display: "flex", justifyContent: "center", alignItems: "center", minHeight: "calc(100vh - 40px)" }}>
      <div className="erp-card" style={{ width: "min(720px, 100%)" }}>
        ...
        <form onSubmit={onSubmit}>
          ...
          <div className="erp-row" style={{ justifyContent: "space-between", marginTop: 8, marginBottom: 16 }}>
            <div className="erp-row" style={{ gap: 16 }}>
              <label className="erp-row" style={{ gap: 8, fontWeight: 900, color: "var(--text-strong)" }}>
          ...
          {msg ? (
            <div style={{ marginBottom: 12, fontWeight: 900, color: "#b91c1c", background: "rgba(185,28,28,0.08)", padding: "10px 12px", borderRadius: 12 }}>
              {msg}
            </div>
          ) : null}
